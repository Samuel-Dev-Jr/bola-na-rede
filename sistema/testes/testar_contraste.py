...
TELAS = [
    ...
    ("Futsal Masculino", "/m/futsal-masculino"),
    ("Futsal Feminino", "/m/futsal-feminino"),
    ("Jiu-Jitsu", "/m/jiu-jitsu"),
    ("Alunos", "/m/futsal-masculino/alunos"),
    ("Matricular", "/m/futsal-masculino/matricular"),
    ("Chamada", "/m/futsal-masculino/chamada"),
    ("Agenda", "/m/futsal-feminino/agenda"),
